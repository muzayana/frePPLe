...
urlpatterns = patterns(
  ...
  (r'^api/input/buffer/(?P<pk>(.+))/$', freppledb.input.serializers.BufferdetailREST.as_view()),
  (r'^api/input/resource/(?P<pk>(.+))/$', freppledb.input.serializers.ResourcedetailREST.as_view()),
  (r'^api/input/location/(?P<pk>(.+))/$', freppledb.input.serializers.LocationdetailREST.as_view()),
  (r'^api/input/customer/(?P<pk>(.+))/$', freppledb.input.serializers.CustomerdetailREST.as_view()),
  (r'^api/input/demand/(?P<pk>(.+))/$', freppledb.input.serializers.DemanddetailREST.as_view()),
  (r'^api/input/item/(?P<pk>(.+))/$', freppledb.input.serializers.ItemdetailREST.as_view()),
  (r'^api/input/load/(?P<pk>(.+))/$', freppledb.input.serializers.LoaddetailREST.as_view()),
  (r'^api/input/flow/(?P<pk>(.+))/$', freppledb.input.serializers.FlowdetailREST.as_view()),
  (r'^api/input/calendar/(?P<pk>(.+))/$', freppledb.input.serializers.CalendardetailREST.as_view()),
  (r'^api/input/calendarbucket/(?P<pk>(.+))/$', freppledb.input.serializers.CalendarBucketdetailREST.as_view()),
  (r'^api/input/operation/(?P<pk>(.+))/$', freppledb.input.serializers.OperationdetailREST.as_view()),
  (r'^api/input/setupmatrix/(?P<pk>(.+))/$', freppledb.input.serializers.SetupMatrixdetailREST.as_view()),
  (r'^api/input/setuprule/(?P<pk>(.+))/$', freppledb.input.serializers.SetupRuledetailREST.as_view()),
  (r'^api/input/suboperation/(?P<pk>(.+))/$', freppledb.input.serializers.SubOperationdetailREST.as_view()),
  (r'^api/input/operationplan/(?P<pk>(.+))/$', freppledb.input.serializers.OperationPlandetailREST.as_view()),
  (r'^api/input/purchaseorder/(?P<pk>(.+))/$', freppledb.input.serializers.PurchaseOrderdetailREST.as_view()),
  (r'^api/input/distributionorder/(?P<pk>(.+))/$', freppledb.input.serializers.DistributionOrderdetailREST.as_view()),
  (r'^api/input/skill/(?P<pk>(.+))/$', freppledb.input.serializers.SkilldetailREST.as_view()),
  (r'^api/input/resourceskill/(?P<pk>(.+))/$', freppledb.input.serializers.ResourceSkilldetailREST.as_view()),
  (r'^api/input/supplier/(?P<pk>(.+))/$', freppledb.input.serializers.SupplierdetailREST.as_view()),
  (r'^api/input/itemsupplier/(?P<pk>(.+))/$', freppledb.input.serializers.ItemSupplierdetailREST.as_view()),
  (r'^api/input/itemdistribution/(?P<pk>(.+))/$', freppledb.input.serializers.ItemDistributiondetailREST.as_view()),
  )
